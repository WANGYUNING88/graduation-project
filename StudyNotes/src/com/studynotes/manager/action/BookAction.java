...
import com.studynotes.manager.service.BookService;
...
public class BookAction {
	...
	public String selectTypeById(Integer type_id,Model model){
	...
	public String selectAllBook(Model model,Integer id,Integer result){
